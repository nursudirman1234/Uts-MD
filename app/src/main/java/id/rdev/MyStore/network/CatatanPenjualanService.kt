package id.rdev.MyStore.network

import id.rdev.MyStore.activity.data_barang.data.ResultDataBarang
import id.rdev.MyStore.activity.login.data.ResultLogin
import id.rdev.MyStore.activity.penjualan.data.ResultKeranjang
import id.rdev.MyStore.activity.penjualan.data.ResultSearchBarang
import id.rdev.MyStore.activity.report.detail.data.ResultItemKeranjang
import id.rdev.MyStore.response.ResultSimple
